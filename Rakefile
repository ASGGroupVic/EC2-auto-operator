...
namespace :residata_dev do
  ...
  desc "Create IAM Policy in DEV"
  task :create_dev_iam_role_policies do
    update_stack('DEV-iam-role-policies', 'base-cloud-formation/iam-role-policy.json', 'residata-dev/parameters/rddev-iam-role-policy-params.json')
  end
...
namespace :residata_prod do
  ...
  desc "Update IAM Managed Policy"
